...
def main():
    ...
    # ------------------------------------------------------------
    # 1) Pairplot of the 4 numeric features
    # ------------------------------------------------------------
    ...
    print("[penguin_plots_ii] Generating pairplot...")
    ...
    pairplot_fig.fig.suptitle("Penguins Pairplot (4 numeric features)", y=1.02)

    # Show pairplot before moving on
    plt.show()

    # ------------------------------------------------------------
    # 2) 3D scatter plot
    # ------------------------------------------------------------
    print("[penguin_plots_ii] Generating 3D scatter...")
    ...
    ax.set_title("3D Scatter: bill_length × bill_depth × flipper_length")
